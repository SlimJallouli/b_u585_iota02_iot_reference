...
//#define I2C_GPO_SYNCHRO_ALLOWED /* allow to use GPO polling as I2C synchronization */
//#define I2C_GPO_INTERRUPT_ALLOWED /* allow to use GPO interrupt as I2C synchronization ! NOT SUPPORTED BY MBED ! */
...
//#if defined(CUSTOM_BUS_H)
//#define M24SR_I2C_Init()                       BSP_I2C1_Init()
//#define M24SR_I2C_DeInit()                     BSP_I2C1_DeInit()
//#define M24SR_I2C_IsReady(DevAddr, Trials)     BSP_I2C1_IsReady(DevAddr, Trials)
//#define M24SR_I2C_Send(DevAddr, pData, Length) BSP_I2C1_Send(DevAddr, pData, Length)
//#define M24SR_I2C_Recv(DevAddr, pData, Length) BSP_I2C1_Recv(DevAddr, pData, Length)
//#elif defined(CUSTOM_BUS_OS_H)
//#define M24SR_I2C_Init()                       BSP_I2C1_Init_OS()
//#define M24SR_I2C_DeInit()                     BSP_I2C1_DeInit_OS()
//#define M24SR_I2C_IsReady(DevAddr, Trials)     BSP_I2C1_IsReady_OS(DevAddr, Trials)
//#define M24SR_I2C_Send(DevAddr, pData, Length) BSP_I2C1_Send_OS(DevAddr, pData, Length)
//#define M24SR_I2C_Recv(DevAddr, pData, Length) BSP_I2C1_Recv_OS(DevAddr, pData, Length)
//#else
#define M24SR_I2C_Init()
#define M24SR_I2C_DeInit()
#define M24SR_I2C_IsReady(DevAddr, Trials)     HAL_I2C_IsDeviceReady(&M24SR_I2C, DevAddr, Trials, 1)
#define M24SR_I2C_Send(DevAddr, pData, Length) HAL_I2C_Master_Transmit(&M24SR_I2C, DevAddr, pData, Length, 1)
#define M24SR_I2C_Recv(DevAddr, pData, Length) HAL_I2C_Master_Receive(&M24SR_I2C, DevAddr, pData, Length, 1000)
//#endif
