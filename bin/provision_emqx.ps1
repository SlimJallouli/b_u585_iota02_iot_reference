...
$emqxCompatibleConfigs = @("MXCHIP_Single", "ST67_T01_Single", "ST67_T02_Single")
if ($configuration -notin $emqxCompatibleConfigs) {
    throw "Configuration '$configuration' is not compatible with broker_type 'emqx'. Allowed values: $($emqxCompatibleConfigs -join ', ')"
}
