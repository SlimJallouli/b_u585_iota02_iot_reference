...
$mosquittoCompatibleConfigs = @("MXCHIP_Single", "ST67_T01_Single", "ST67_T02_Single")
if ($configuration -notin $mosquittoCompatibleConfigs) {
    throw "Configuration '$configuration' is not compatible with broker_type 'mosquitto'. Allowed values: $($mosquittoCompatibleConfigs -join ', ')"
}
